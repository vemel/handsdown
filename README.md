...
- #️⃣ Create links easily as `handsdown.generator.Generator.replace_links` (check [index.md](https://github.com/vemel/handsdown/blob/master/docs/index.md#features))
